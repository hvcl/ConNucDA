...
accelerate launch --config_file scripts/pannuke/train_base_ratio_class_256x256.yaml \
    train.py \
    --root_dir /Dataset/pannuke/splits \
    --caption_list_dir data/caption_files/pannuke+ratio \
    --test_caption_files data/eval_samples/pannuke/pannuke_test_ratio.jsonl \
    --dataset pannuke \
    --num_classes 6 \
