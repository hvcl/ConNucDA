...
python test_class.py --model_type=base_256x256 \
    ...
    --dataset pannuke \
    --num_classes 6 \
    --save_path=results/pannuke/base_256x256/240213_061100_ratio-class_256x256/300000_val_4/base.png \
    --save_img_path=outputs/pannuke/base_256x256/240213_061100_ratio-class_256x256/300000_val_4/ \
    --caption_list_dir data/eval_samples/pannuke/pannuke_val_ratio-class.json
