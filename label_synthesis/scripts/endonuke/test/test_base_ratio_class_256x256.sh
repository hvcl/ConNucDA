...
python test_class.py --model_type=base_256x256 \
    ...
    --dataset endonuke \
    --num_classes 4 \
    --save_path=results/endonuke/base_256x256/240213_061059_ratio-class_256x256/300000_7/base.png \
    --save_img_path=outputs/endonuke/base_256x256/240213_061059_ratio-class_256x256/300000_7/ \
    --caption_list_dir data/eval_samples/endonuke/endonuke_test_ratio-class.json
