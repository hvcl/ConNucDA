...
from imagen_pytorch.plip import DEFAULT_PLIP_NAME, PLIP_EMBED_DIM, MAX_LENGTH, FrozenCLIPEmbedder
...
class JointUnet(nn.Module):
    def __init__(
        ...
        *,
        ...
        # text_embed_dim=get_encoded_dim(DEFAULT_PLIP_NAME),
        text_embed_dim=PLIP_EMBED_DIM,
        num_resnet_blocks=1,
        cond_dim=None,
        num_image_tokens=4,
        num_time_tokens=2,
        ...
        # print("text_embed_dim, cond_dim:", text_embed_dim, cond_dim)
        # exit()
        if cond_on_text:
            assert exists(text_embed_dim), 'text_embed_dim must be given to the unet if cond_on_text is True'
            self.text_to_cond = nn.Linear(text_embed_dim, cond_dim) # PLIP: 512->128
    ...
    def forward(
        ...
        *,
        ...
        if exists(text_embeds) and self.cond_on_text:
            ...
            # text_embeds.shape: [1, 154, 512]
            # text_tokens.shape: [1, 154, 128]
            ...
            text_tokens_len = text_tokens.shape[1] # 154
...
class JointImagen(nn.Module):
    def __init__(
        ...
        *,
        ...
        num_classes,
        text_encoder_name=DEFAULT_PLIP_NAME,
        # text_embed_dim=None,
        text_embed_dim=PLIP_EMBED_DIM,
        channels=3,
        timesteps=1000,
