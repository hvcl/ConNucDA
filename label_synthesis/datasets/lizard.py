...
classes = [
    ...
    LizardClass('Connective_tissue',  6, True,  (  51, 51, 255)), # cyan (similar to blue)
]
# autopep8: on
num_classes = 7
...
class LizardDataset(Dataset):
    def __init__(
        ...
        if "+" in caption_list_dir:
            ...
            # self.plus_setting = plus_setting
        
        json_fn = f'lizard_{split}_{plus_setting}.json'
        ...
        # print(len(self.images), len(self.labels), len(self.hvs))
        # print(self.images[:3])
        # print(self.labels[:3])
        # print(self.hvs[:3])
