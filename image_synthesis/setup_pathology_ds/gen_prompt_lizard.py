...
# V1: A pathology image
# V2: A histopathology colon tissue nuclei image
# V1~V3: no eosinophil
# V4: eosinophil is added
# V5: "hematoxylin and eosin stained" added

base_prompt = "high quality histopathology H&E-stained colon tissue nuclei image"

data_pth = '/Dataset/lizard/NASDM/lizard_split_norm_256'
target = "test"
...
json_file_path = f'lizard_{target}.json'
with open(json_file_path, 'w') as json_file:
