...
### lizard
# python train-seg_edge_hv-resume.py --dataset lizard --setting iter100k_b32 --resume_path ./lightning_logs/lizard-setting_iter50k_b32/epoch=130-step=49999.ckpt

### pannuke
# python train-seg_edge_hv-resume.py --dataset pannuke --setting iter100k_b32 --resume_path ./lightning_logs/pannuke-setting_iter50k_b32/epoch=131-step=26399.ckpt
# python train-seg_edge_hv-resume.py --dataset pannuke --setting iter100k_b32 --resume_path ./lightning_logs/pannuke-setting_iter50k_b32/epoch=249-step=49999.ckpt

### endonuke
# python train-seg_edge_hv-resume.py --dataset endonuke --setting iter100k_b32 --resume_path ./lightning_logs/endonuke-setting_iter50k_b32/epoch=832-step=39983.ckpt
...
if args.setting=="iter50k_b32":
    max_steps = 50000
    batch_size = 32
elif args.setting=="iter100k_b32":
    max_steps = 50000
    batch_size = 32
    learning_rate = 5e-6
