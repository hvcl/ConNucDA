...
from seg_edge_hv.lizard_dataset_test import MyDataset
...
model = create_model('./models/cond_seg_edge_hv/cldm_pathLDM_lizard.yaml').cpu()
 
### seg edge hv
# model.load_state_dict(load_state_dict('./lightning_logs/lizard-setting_iter50k_b32/epoch=130-step=49999.ckpt', location='cuda'))
model.load_state_dict(load_state_dict('./lightning_logs/lizard-setting_iter100k_b32/epoch=53-step=20735.ckpt', location='cuda'))

### seg edge
# model.load_state_dict(load_state_dict('./lightning_logs/lizard-setting_iter100k/epoch=65-step=49999.ckpt', location='cuda'))
# model.load_state_dict(load_state_dict('./lightning_logs/lizard-setting_iter150k/epoch=65-step=49999.ckpt', location='cuda'))
# model.load_state_dict(load_state_dict('./lightning_logs/lizard-setting_iter200k/epoch=101-step=78335.ckpt', location='cuda'))
model = model.cuda()
...
for scale in scales:
    sample_dir = f"./lightning_logs/lizard-setting_iter100k_b32/step20735/samples_50/scale{scale}"
    grid_dir = f"./lightning_logs/lizard-setting_iter100k_b32/step20735/grids_50/scale{scale}"
