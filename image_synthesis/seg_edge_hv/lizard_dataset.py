...
class MyDataset(Dataset):
    def __init__(self):
        self.data = []
        with open('./setup_pathology_ds/v5/lizard_train.json', 'rt') as f:
            for line in f:
    ...
    def __getitem__(self, idx):
        ...
        img_fn = item['images']
        fn_npy = os.path.basename(img_fn).split('.png')[0] + '.npy'
        hv_fn = os.path.join(self.lizard_data_path, 'dist_masks/train', fn_npy)
    ...
    def set_prompt(self, cls):
        prompt = "high quality histopathology H&E-stained colon tissue image"
