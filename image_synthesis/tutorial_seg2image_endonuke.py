...
from seg_edge_hv.endonuke_dataset_test import MyDataset
# from tutorial_dataset_test_endonuke import MyDataset
...
#     EndonukeClass('Stroma',         1, True,  ( 65, 105, 225)), # royal blue
#     EndonukeClass('Epithelium',     2, True,  ( 76, 153,   0)), # green
#     EndonukeClass('Others',         3, True,  (220,  20,  60)), # crimson red
#     EndonukeClass('edge',           4, True,  (255, 255, 255)), # white
# ]
classes = [
    EndonukeClass('Background',  0, True,  (  0,   0,   0)), # black
...
model = create_model('./models/cond_seg_edge_hv/cldm_pathLDM_endonuke.yaml').cpu()
model.load_state_dict(load_state_dict('./lightning_logs/endonuke-setting_iter100k_b32/epoch=1041-step=49999.ckpt', location='cuda'))
model = model.cuda()
...
for scale in scales:
    sample_dir = f"./lightning_logs/endonuke-setting_iter100k_b32/samples_500/scale{scale}"
    grid_dir = f"./lightning_logs/endonuke-setting_iter100k_b32/grids_500/scale{scale}"
    # sample_dir = f"./lightning_logs/endonuke-setting_iter50k_b32/samples/scale{scale}"
    # grid_dir = f"./lightning_logs/endonuke-setting_iter50k_b32/grids/scale{scale}"
    # sample_dir = f"./lightning_logs/endonuke-setting_iter50k_b32/samples_synthetic/scale{scale}"
    # grid_dir = f"./lightning_logs/endonuke-setting_iter50k_b32/grids_synthetic/scale{scale}"
