...
from seg_edge_hv.pannuke_dataset_test import MyDataset
...
# model.load_state_dict(load_state_dict('./lightning_logs/pannuke-setting_iter100k_b32/epoch=116-step=23399.ckpt', location='cuda'))
...
for scale in scales:
    sample_dir = f"./lightning_logs/pannuke-setting_iter100k_b32/samples_100/scale{scale}"
    grid_dir = f"./lightning_logs/pannuke-setting_iter100k_b32/grids_100/scale{scale}"
